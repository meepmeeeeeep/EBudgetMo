...
const Dashboard = ({ navigation }) => {
    ...
    const nextPage = async () => {
        navigation.replace('WelcomePage4');
    };

    return (
        <View style={styles.container}>
            <View style={styles.content}>
                <WelcomeImage imageSource={require('../../assets/images/Checklist.png')}/>

                <WelcomeTitle>Set Goals & Save Smart</WelcomeTitle>
                <WelcomeSubtext style={styles.subtext}>Plan ahead and achieve financial stability by setting clear savings goals with helpful reminders.</WelcomeSubtext>
            </View>
